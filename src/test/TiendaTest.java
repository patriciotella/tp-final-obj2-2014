...
public class TiendaTest {
	 ...
	 * Tiraba NullPointerException y eso porque no estaban inicializadas las variables
	 * de instancia antes de crear la tienda en el setUp.*/
	...
	private void configurarMockVenta(Venta unMockDeVenta, Cliente unMockDeCliente, boolean fueCompradaPor, Float unMonto){
		Mockito.when(unMockDeVenta.fueCompradaPor(unMockDeCliente)).thenReturn(fueCompradaPor);
	...
	@Test
	public void testUbicarPresentacionEnTienda() throws PresentacionNotFoundException {
		presentacion1 = Mockito.mock(Presentacion.class);
		Mockito.when(stock3.esStockDePresentacion(presentacion1)).thenReturn(true);
