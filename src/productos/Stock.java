 ...
 * Contene una Presentacion de la cual se sabe la cantidad que hay en la Tienda (indicado por el int).
 */
public class Stock {
	...
	/**
	 * Indica si el Stock en la tienda es igual a la cantidad minima que debe tener la Presentacion
	 * @return boolean
	 */
	...
	/**
	 * Indica si el Stock en la tienda es igual a la cantidad critica que debe tener la Presentacion
	 * @return boolean
	 */
	...
	/**
	 * Indica si la Presentacion contenida en el Stock es la misma Presentacion pasada como parametro.
	 * @param Presentacion unaPresentacion
	 * @return boolean
	 */
